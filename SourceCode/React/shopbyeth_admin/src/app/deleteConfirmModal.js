                ...
                <div className="col-lg-10">
                  <div className="form-group mt-4">
                    ...
                    <div className="button-container py-4 d-flex justify-content-around">
                      <button className='button' style={{ backgroundColor: 'green' }} onClick={e => confirm(e)}>Yes</button>
                      <button className='button' style={{ backgroundColor: 'red' }} onClick={e => close(e)} >No</button>
                    </div>
                  </div>
