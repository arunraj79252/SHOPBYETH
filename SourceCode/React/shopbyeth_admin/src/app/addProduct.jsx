...
const AddProduct = () => {
  ...
  const submitHandle = async (e) => {
    ...
    await appContext
      .getAxios()
      .post(baseURL + "admin/products", productBody)
      .then((res) => {
        console.log(res);
  ...
  const productValidate = () => {
    return new Promise((resolve, reject) => {
      const nameRegex = new RegExp("^[0-9a-zA-Z \b]+$");
  ...
  useEffect(() => {
    // debugger;
    let string = "Price should not be greater than MRP"
    console.log(error.price.length);
  ...
  const setCroppedData = async (file, preview) => {
    ...
    console.log(file.size / 1024 / 1024, "cropssss");
    ...
    if (len !== 0) {
      ...
      // await testFunction(crop);

      // console.log(croppedFile.le);

      // setCoverId("image"+date)
  ...
  const imageUpload = async (file, crop) => {
    ...
    //      "authorization" :'ADMIN@SHOPBYETH '+token},
    //   })
  ...
  useEffect(() => {
    if (
      error.image &&
      croppedFile.length > 2 &&
      croppedFile[croppedFile.length - 1].status === 100
    ) {
      setError((prevState) => ({
        ...prevState,
        image: "",
  ...
  const deleteImage = (e, id) => {
    ...
    // setCroppedFile(cr)
    let objIndex = croppedFile.findIndex((res) => res.file === id);
  ...
  return (
    <div className="container mb-5 pb-5">
      <h2 className="mb-5 mt-5">Add Products</h2>
      <div className="card ">
        <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <select
                      className={`form-select ${error.brandId ? "is-invalid" : ""
                        }`}
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <select
                      className={`form-select ${error.subCategoryId ? "is-invalid" : ""
                        }`}
                      id="exampleFormControlSelect1"
                      onChange={(e) => onInputChange(e)}
                      name="subCategoryId"
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <select
                      className={`form-select ${error.typeId ? "is-invalid" : ""
                        }`}
                      id="exampleFormControlSelect1"
                      onChange={(e) => onInputChange(e)}
                      ...
                      name="typeId"
                    >
                      {/* {strapMaterialList.map((res,inde))=>{
                        <option key={index} value={res.id}>
                          {res.name}
                        </option>
                      }} */}
                      <option value={"-1"} hidden></option>
                      {typeList.length ? typeList.map((res, index) => {
                        return (
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <select
                      className={`form-select ${error.gender ? "is-invalid" : ""
                        }`}
                      id="exampleFormControlSelect1"
                      onChange={(e) => onInputChange(e)}
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <input
                      ...
                      placeholder=""
                      className={`form-control ${error.originalPrice ? "is-invalid" : ""
                        }`}
                      onChange={(e) => onInputChange(e)}
                    />
                    {error.originalPrice ? (
                ...
                <div className="col-lg-3 col-12">
                  <div className="form-group mt-4">
                    ...
                    <input
                      ...
                      placeholder=""
                      className={`form-control ${error.availableStock ? "is-invalid" : ""
                        }`}
                      onChange={(e) => onInputChange(e)}
                    />
                    ...
                    return (
                      <React.Fragment key={index}>
                        <div className="col-lg-5 my-1 col-6">
                          <input
                            type="text"
                            className={`form-control ${error.specification ? "is-invalid" : ""
                              }`}
                            name="key"
                            value={res.key}
                        ...
                        <div className="col-lg-2 col-12 delete-spec">
                          {/* <span className="down-arrow" onClick={e=>specDeleteHandler(e,index)}><AiFillDelete/></span> */}
        ...
        checked={crop.coverImage}
        onChange={e=>coverChange(e,crop.id)}
      /> */}
                        </Card>
                        {crop.status === 100 ? (
                        ...
                        <div className="button-container">
                          ...
                          {(crop.completed === true || crop.status === -1) && (
                            <button
                              type="button"
                              className="btn delete-button"
                              onClick={(e) => deleteImage(e, crop.file)}
                            >
                              <AiFillDelete />
                            </button>
                          )}
                        ...
                        {/* <img src={crop.preview} height={750} width={550} className="" alt="" /> */}
                      </div>
                    ))}
                  </div>
                </div>
